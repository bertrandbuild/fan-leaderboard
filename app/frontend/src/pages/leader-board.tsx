...
export function LeaderBoard() {
  ...
  useEffect(() => {
    const filtered =
      activeSport === "all"
        ? clubs
        : clubs.filter((club) => club.sport === activeSport);
  ...
  const filteredUsers = useMemo(() => {
    ...
    return filteredUsers.sort((a, b) => {
      switch (userSortBy) {
        ...
        case "monthly":
          return (
            b.achievements.monthlyActivity - a.achievements.monthlyActivity
          );
        default:
    ...
    <div className="space-y-6 w-full">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-400 mt-1 md:mt-2 text-sm md:text-base">
            Global and internal rankings with social media sorting
          </p>
        </div>
        ...
        <>
          ...
          <div className="flex flex-col md:flex-row items-center md:justify-center w-full mb-8 gap-4">
            ...
            {topClubs[1] && (
              <Card className="flex-1 bg-slate-800 border-slate-700 scale-90 z-10">
                <CardContent className="flex flex-col items-center p-2 md:p-4">
                  <div className="w-10 md:w-12 h-10 md:h-12 rounded-full bg-gray-400 flex items-center justify-center text-white font-bold text-lg md:text-xl mb-2">
                    2
                  </div>
                  <div className="text-white font-medium text-center text-base md:text-lg">
                    {topClubs[1].name}
                  </div>
                  <div className="text-slate-400 text-xs md:text-sm">
                    {topClubs[1].stats.points.toLocaleString()} pts
                  </div>
            ...
            {topClubs[0] && (
              <Card className="flex-1 bg-slate-800 border-2 border-yellow-400 scale-110 z-20 shadow-lg">
                <CardContent className="flex flex-col items-center p-3 md:p-6">
                  <div className="w-12 md:w-16 h-12 md:h-16 rounded-full bg-yellow-500 flex items-center justify-center text-white font-bold text-xl md:text-2xl mb-2">
                    1
                  </div>
                  <div className="text-white font-bold text-lg md:text-2xl text-center">
                    {topClubs[0].name}
                  </div>
                  <div className="text-yellow-300 text-sm md:text-base font-semibold">
                    {topClubs[0].stats.points.toLocaleString()} pts
                  </div>
                  <Badge className="bg-orange-500 text-white mt-2">
                    {topClubs[0].sport}
                  </Badge>
            ...
            {topClubs[2] && (
              <Card className="flex-1 bg-slate-800 border-slate-700 scale-90 z-10">
                <CardContent className="flex flex-col items-center p-2 md:p-4">
                  <div className="w-10 md:w-12 h-10 md:h-12 rounded-full bg-orange-600 flex items-center justify-center text-white font-bold text-lg md:text-xl mb-2">
                    3
                  </div>
                  <div className="text-white font-medium text-center text-base md:text-lg">
                    {topClubs[2].name}
                  ...
                  <div className="text-slate-400 text-xs md:text-sm">
                    {topClubs[2].stats.points.toLocaleString()} pts
                  </div>
                  <Badge className="bg-orange-500 text-white mt-2">
                    {topClubs[2].sport}
                  </Badge>
            ...
            <CardHeader>
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                <CardTitle className="text-white">
                  Global Ranking ({filteredClubs.length} clubs)
                </CardTitle>
              ...
              <div className="space-y-3 max-h-80 md:max-h-96 overflow-y-auto">
                {filteredClubs.map((club, index) =>
                  club.name === "Ultimate Fighting Championship" ? (
                    <Card
                      key={club.id}
                      className="bg-gradient-to-br from-purple-900 via-fuchsia-700 to-slate-800 border-2 border-fuchsia-500 shadow-lg p-2 md:p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between mb-2"
                    >
                      <CardContent className="flex flex-col sm:flex-row items-start sm:items-center justify-between w-full p-0 gap-2">
                        <div className="flex items-center gap-2 md:gap-4">
                          <div className="text-fuchsia-400 font-bold text-lg md:text-2xl">
                            #{index + 1}
                          </div>
                          <div>
                        ...
                        <div className="flex items-center gap-2 md:gap-6 text-right mt-2 sm:mt-0">
                          <div>
                            <div className="text-white font-bold text-base md:text-lg">
                              {club.stats.points.toLocaleString()}
                            </div>
                          ...
                          <div>
                            <div className="text-cyan-400 font-bold text-base md:text-lg">
                              {club.stats.members.toLocaleString()}
                            </div>
                            <div className="text-fuchsia-300 text-xs">
                              members
                            </div>
                          ...
                          <div>
                            <div className="text-green-400 font-bold text-base md:text-lg">
                              {club.stats.engagement}%
                            </div>
                            <div className="text-fuchsia-300 text-xs">
                              engagement
                            </div>
                          </div>
                          <Badge className="bg-fuchsia-600 text-white text-xs md:text-base px-2 md:px-3 py-1 ml-2">
                            {club.sport}
                          </Badge>
                        </div>
                      </CardContent>
                    ...
                    <div
                      key={club.id}
                      className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-2 md:p-3 bg-slate-700 rounded-lg hover:bg-slate-600 transition-colors gap-2"
                    >
                      ...
                      <div className="flex items-center gap-2 md:gap-4 text-right">
                        ...
                        <div>
                          <div className="text-cyan-400 font-medium text-base md:text-lg">
                            {club.stats.members.toLocaleString()}
                          </div>
                          <div className="text-slate-400 text-xs md:text-sm">
                            members
                        ...
                        <div>
                          <div className="text-green-400 font-medium text-base md:text-lg">
                            {club.stats.engagement}%
                          </div>
                          <div className="text-slate-400 text-xs md:text-sm">
                            engagement
      ...
      {activeTab === "interne" && (
        <div className="space-y-6">
          ...
          {selectedClubData &&
          selectedClubData.name === "Ultimate Fighting Championship"
            ? (() => {
                ...
                return (
                  <div className="flex flex-col md:flex-row items-center md:justify-center w-full mb-8 gap-4">
                    ...
                    {topUfcUsers[0] && (
                      <Card className="flex-1 bg-slate-800 border-2 border-yellow-400 scale-110 z-20 shadow-lg">
                        <CardContent className="flex flex-col items-center p-3 md:p-6">
                          <div className="w-12 md:w-16 h-12 md:h-16 rounded-full bg-yellow-400 flex items-center justify-center text-white font-bold text-xl md:text-2xl mb-2">
                            1
                          </div>
                          <div className="text-white font-bold text-lg md:text-2xl text-center">
                            {topUfcUsers[0].username}
                          </div>
                          <div className="text-yellow-200 text-sm md:text-base font-semibold">
                            {topUfcUsers[0].points.toLocaleString()} pts
                          </div>
                          <Badge className="bg-yellow-600 text-white mt-2">
                            {topUfcUsers[0].clubName}
                          </Badge>
                        </CardContent>
                      </Card>
                    )}
                    ...
                    {topUfcUsers[2] && (
                      <Card className="flex-1 bg-slate-800 border-slate-700 scale-90 z-10">
                        <CardContent className="flex flex-col items-center p-2 md:p-4">
                          ...
                          <div className="text-white font-medium text-center text-base md:text-lg">
                            {topUfcUsers[2].username}
                          </div>
                          <div className="text-yellow-300 text-xs md:text-sm">
                            {topUfcUsers[2].points.toLocaleString()} pts
                          </div>
                          <Badge className="bg-yellow-600 text-white mt-2">
                            {topUfcUsers[2].clubName}
                          </Badge>
                        </CardContent>
                      </Card>
                    )}
                ...
                <Card className="bg-gradient-to-r from-slate-800 to-slate-700 border-slate-600">
                  <CardHeader>
                    ...
                    <p className="text-slate-400 text-xs md:text-base">
                      {selectedClubData.category} • {selectedClubData.region}
                    </p>
                  </CardHeader>
                  <CardContent>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      <div className="text-center">
                        <div className="text-lg md:text-2xl font-bold text-white">
                          {selectedClubData.stats.points.toLocaleString()}
                        </div>
                        <div className="text-slate-400 text-xs md:text-sm">
                          Points
                        </div>
                      ...
                      <div className="text-center">
                        <div className="text-lg md:text-2xl font-bold text-cyan-400">
                          {selectedClubData.stats.members.toLocaleString()}
                        </div>
                        <div className="text-slate-400 text-xs md:text-sm">
                          Members
                        </div>
                      ...
                      <div className="text-center">
                        <div className="text-lg md:text-2xl font-bold text-green-400">
                          {selectedClubData.stats.engagement}%
                        </div>
                        <div className="text-slate-400 text-xs md:text-sm">
                          Engagement
                        </div>
                      ...
                      <div className="text-center">
                        <div className="text-lg md:text-2xl font-bold text-orange-400">
                          {selectedClubData.stats.totalActivity.toLocaleString()}
                        </div>
                        <div className="text-slate-400 text-xs md:text-sm">
                          Activity
                        </div>
          ...
          <Card className="bg-slate-800 border-slate-700">
            <CardHeader>
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2">
                <CardTitle className="text-white">
                  Internal Ranking ({filteredUsers.length} users)
                </CardTitle>
              ...
              <div className="space-y-3 max-h-80 md:max-h-96 overflow-y-auto">
                {filteredUsers.map((user, index) =>
                  ...
                  index === 0 ? (
                    <div
                      key={user.id}
                      className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-2 md:p-3 bg-gradient-to-br from-purple-900 via-fuchsia-700 to-slate-800 border-2 border-fuchsia-500 shadow-lg rounded-lg hover:bg-fuchsia-800/80 transition-colors gap-2"
                    >
                      <div className="flex items-center gap-2 md:gap-3">
                        <div className="text-fuchsia-200 font-extrabold w-8 text-center text-lg md:text-xl drop-shadow">
                          #{index + 1}
                        </div>
                        <div>
                          ...
                          <div className="text-fuchsia-300 text-xs md:text-base font-semibold">
                            {user.clubName}
                          </div>
                        </div>
                      </div>
                      <div className="flex items-center gap-2 md:gap-6 text-right mt-2 sm:mt-0">
                        ...
                        <div>
                          <div className="text-cyan-400 font-bold text-base md:text-lg">
                            {user.tokens.amount.toLocaleString()}
                          </div>
                          <div className="text-fuchsia-300 text-xs">tokens</div>
                        </div>
                        <div>
                          <div className="text-green-400 font-bold text-base md:text-lg">
                            {user.achievements.totalActivity.toLocaleString()}
                          </div>
                          <div className="text-fuchsia-300 text-xs">
                            activity
                          </div>
                        </div>
                        <Badge className="bg-fuchsia-600 text-white text-xs md:text-base px-2 md:px-3 py-1 ml-2 shadow">
                          {user.clubName}
                        </Badge>
                      </div>
                    </div>
