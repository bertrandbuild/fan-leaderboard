      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-2">
        <div>
          <h1 className="text-3xl font-bold text-white">
            Pull Management <span className="text-orange-400">– Paris Saint-Germain</span>
          </h1>
      ...
      <Card className="bg-slate-800 border-slate-700 mb-4">
        <CardHeader>
          <div className="flex items-center gap-3">
            ...
            <CardTitle className="text-white text-lg">Active Pool</CardTitle>
        ...
        <Card className="bg-slate-800 border-slate-700 flex flex-col h-full">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-white">Pool Participants</CardTitle>
            </div>
            <p className="text-slate-400 text-sm">List of users in the pool</p>
          </CardHeader>
          <CardContent>
        ...
        <Card className="bg-slate-800 border-slate-700 flex flex-col h-full">
          <CardHeader>
            <div className="flex items-center gap-2">
              ...
              <CardTitle className="text-white">Pool Ranking</CardTitle>
              <Button
                size="sm"
                variant="outline"
